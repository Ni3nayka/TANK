...
uint8_t  PS2_clock          = A0;                                                                                 // Вывод Arduino, к которому подключен вывод приёмника геймпада CLK
uint8_t  PS2_data           = A1;                                                                                 // Вывод Arduino, к которому подключен вывод приёмника геймпада DAT
uint8_t  PS2_command        = A2;                                                                                 // Вывод Arduino, к которому подключен вывод приёмника геймпада CMD
...
void setup(){
 ...
 //error = ps2x.config_gamepad(A0,A2,A3,A1, true, true);   //setup pins and settings:  GamePad(clock, command, attention, data, Pressures?, Rumble?) check for error
